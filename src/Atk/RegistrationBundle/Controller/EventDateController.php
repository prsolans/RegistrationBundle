...
use Atk\RegistrationBundle\Entity\EventDate;
...
class EventDateController extends Controller
{
    ...
    */
    protected function paginator($queryBuilder)
    {
        ...
        {
            return $me->generateUrl('admin_eventdate', array('page' => $page));
        };
    ...
    public function createAction(Request $request)
    {
        ...
        $form = $this->createForm(new EventDateType(), $entity);
        $form->bind($request);
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AtkRegistrationBundle:EventDate')->find($id);
    ...
    public function editAction($id)
    {
        ...
        $editForm = $this->createForm(new EventDateType(), $entity);
        $deleteForm = $this->createDeleteForm($id);
